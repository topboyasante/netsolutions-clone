...
function CXODashboard() {
  return (
    ...
    <section className='max-w-[1600px] mx-auto h-full py-5'>
      ...
      <section className='xl:relative xl:bg-[url("https://www.netsolutions.com/assets/images/net-solutions-analytical-graphs-tablet-devices.webp")]
      w-full h-[80%] bg-no-repeat bg-cover my-5'>
          <img src="https://www.netsolutions.com/assets/images/net-solutions-analytical-graphs-tablet-devices.webp" alt="hubpix" className='block xl:hidden'/>
