...
function CXODashboard() {
  return (
    ...
    <section className='max-w-[1600px] mx-auto h-full py-5'>
      <h1 className='text-6xl font-extrabold'>Leverage Our Data-Driven Approach to Separate Yourself From Your Competition</h1>
      <section className='relative bg-[url("https://www.netsolutions.com/assets/images/net-solutions-analytical-graphs-tablet-devices.webp")]
      w-full h-[80%] bg-no-repeat bg-cover my-5'>
          ...
          <div className="absolute bg-white bottom-0 left-[5em] w-[40%] p-[3em]">
            ...
            <p className='font-extralight text-2xl my-5'>Here at Net Solutions, we practice what we preach. 
